     ...
     min-h-screen flex flex-col justify-start items-center p-5  text-center
      ...
      <div className='inline-block'>
          ...
          <p className='max-w-xl font-light text-gray-500 text-xl'> 
              Hello <span className='animate-pulse text-4xl'>👋</span> I'm Hussain Ahmad, an <h2 className='text-2xl py-5'>IIT JAMMU, MTECH, CSE 2027</h2> graduate based in India. I enjoy building things for the web. I'm currently working on 
